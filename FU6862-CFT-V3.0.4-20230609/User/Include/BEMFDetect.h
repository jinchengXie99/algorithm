...
//定义使用BEMF启动最低转速,ROM
#define     BEMFMotorStartSpeed                       Motor_Loop_Speed//_Q15(8000.0/MOTOR_SPEED_BASE)
#define     BEMFMotorStartSpeedHigh                   _Q15(MOTOR_SPEED_BASE/MOTOR_SPEED_BASE)//_Q15(80000.0/MOTOR_SPEED_BASE)
